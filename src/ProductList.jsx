            ...
            {!showCart ? (
                <div className="product-grid">
                    {plantsArray.map((category, index) => (
                        <div key={index}>
                            <h1>
                                <div style={styleB}>{category.category}</div>
                            </h1>
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <button
                                            disabled={cart.some(element => element.name === plant.name)}
                                            className={!cart.some(element => element.name === plant.name) ? 'product-button' : 'disable-button'}
                                            onClick={() => handleAddToCart(plant, index * category.plants.length + plantIndex)}
                                        >
                                            Add to Cart
                                        </button>
                                    </div>
